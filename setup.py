...
SHORT_DESCRIPTION = "Test github pipeline"
URL = "https://github.com/KnightConan/test-pyckage-github/settings/secrets/actions"
AUTHOR = 'Zhiwei Zhang'
...
setup(name=NAME,
      ...
      url=URL,
      packages=find_packages(include=["test_pyckage_github*"],
                             exclude=["tests*", "docs*"]),
