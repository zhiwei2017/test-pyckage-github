...
Report bugs at https://github.com/KnightConan/test-pyckage-github/settings/secrets/actions/issues.
...
The best way to send feedback is to file an issue at https://github.com/KnightConan/test-pyckage-github/settings/secrets/actions/issues.
...
Assume that bump2version_ is installed. To deploy the package, just run::
    ...
    $ bump2version patch test_pyckage_github/version.py  # possible: major / minor / patch
    $ git push
    $ git push --tags
